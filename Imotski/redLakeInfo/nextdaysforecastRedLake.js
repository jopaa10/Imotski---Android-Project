...
import NextDaysTemplateItem from './nextdaysTemplateRedLake';
...
export const NextDaysForecastRedLake = props => {
  ...
  return (
    <ScrollView style={[styles.container, {flexDirection: 'column'}]}>
      ...
      <View style={{height: windowHeight * 0.32, backgroundColor: '#CA9A8C'}}>
        <TouchableOpacity
