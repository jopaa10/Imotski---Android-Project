...
export const ShoppingMall = () => {
  ...
  const handleCoffeeSearch = () => {
    fetch(
      `https://maps.googleapis.com/maps/api/place/nearbysearch/json?&keyword=mall&location=${currentCoord.lat},${currentCoord.lng}&radius=30000&key=AIzaSyBWeAUtDlbMRmnqsLSvQVbO7BsQzxGQDpo`,
    )
      .then(res => res.json())
      .then(data => {
